...
//temp save deck so I dont have to retype trying out the combinations
// var deck = ["2h","ah","kh","qh","jh","10h","9h","8h","7h","6h","5h","4h","3h",
//             "2d","ad","kd","qd","jd","10d","9d","8d","7d","6d","5d","4d","3d",
//             "2c","ac","kc","qc","jc","10c","9c","8c","7c","6c","5c","4c","3c",
//             "2s","as","ks","qs","js","10s","9s","8s","7s","6s","5s","4s","3s",
...
//The winner of the previous game will begin the following game.
  ...
  function rungame(){
    //stipulations
    //cards shuffled and delt
    // need to run playercheck
    if(playercheck() === "player1"){
      //initialize steps for player1 to select cards and play
    }else{
      //player2 goes first
